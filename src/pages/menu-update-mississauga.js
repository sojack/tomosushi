 ...
 <div className="menuSection">
        ...
        <div className="menuSection">
          ...
          <div className="menuItem">
            ...
            <div className="menuOption menuOptionTwo">
              <span className="optionDesc">
              8 pcs Seared salmon and scallop  on California roll with spicy mayo
              </span>
              <span className="optionPrice">$16</span>
            </div>
          </div>
          ...
          <div className="menuItem">
            ...
            <div className="menuOption menuOptionTwo">
              <span className="optionDesc">
              Seared albacore tuna, and escolar on top of crab salad and kappa roll with spicy mayo & scallion
              </span>
              <span className="optionPrice">$16</span>
            </div>
          </div>          
